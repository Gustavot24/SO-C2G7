...
function tipoAlgoritmo() {
	...
	if (algoritmo == "Round Robin") {
		document.getElementById("ingresarQuantum").style.display = "block";
	} else {
		document.getElementById("ingresarQuantum").style.display = "none";
	}
...
function validarQuantum() {
	validarQuantum:{
		...
		quantum = (document.getElementById("quantum").value).split("");
